<template>
  <section class="section">
    <div class="container content has-text-centered">
      ...
      <p>We are very excited to announce that the second edition of the Paredes de Coura Fan Weekend is coming soon.</p>
      ...
      <p>Registrations will be from 1 of January to 28 of February, 2018.</p>
    </div>
  </section>
</template>
